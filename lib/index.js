...
function addFavorite () {
  if (loc.value != '') {
    ...
    var dataObject = { "location": `${cityState}`, "api_key": "a6df4e17-044c-4245-8132-3a9a6c4eb53b" };
...
function getFavorites () {
  ...
  favoritesRequest.open('GET', 'http://localhost:3000/api/v1/favorites?api_key=a6df4e17-044c-4245-8132-3a9a6c4eb53b'); 
